    ...
    render() {
        return (
            ...
            <path fill="url(#PSgrad_0)">
                ...
                <text x="40" y="130">Student Registration for </text>
                <text x="95" y="150">Placement</text>
                <text   x="10" y="200"  ></text>
            </svg>
            </div>
            <div className="container text-center" id='about'>
            The Student Registration for Placement will help student as well as placement cell. The students can get information's and notification from this easily.
                Students can also generate resume from Student placement system.
            </div>
